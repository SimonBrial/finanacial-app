...
import { ButtonCustomProps } from "../../types/interface";
...
export default function ButtonCustom({
  ...
  const themedStyles = useMemo(() => {
    ...
    const activeColor = disabled ? globalStyles.ButtonCustomDisabled : color;
    const contentColor = isFilled
      ? disabled
        ? globalStyles.ButtonCustomDisabledText
        : "#FFFFFF"
      : disabled
        ? globalStyles.ButtonCustomDisabledText
        : activeColor;
    ...
    const variantStyles: Record<PrimitiveVariants, ViewStyle> = {
      filled: {
        backgroundColor: disabled ? globalStyles.ButtonCustomDisabled : color,
        borderWidth: 0,
      },
      ...
      ghost: {
        backgroundColor: disabled
          ? globalStyles.ButtonCustomDisabled
          : `${color}25`,
        borderWidth: 0,
      },
      flat: {},
