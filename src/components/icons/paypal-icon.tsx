...
import { PaypalIconProps } from "../../types/interface";
...
export default function PaypalIcon({
  ...
  // Si pasas 'size', ajustamos ambos para mantener la proporción
  const finalWidth = size || width;
  const finalHeight = size ? size * 1.2 : height;
  ...
  return (
    <Svg
      ...
      fill="none" // Quitamos el fill general para que manden los paths
    >
      <G id="SVGRepo_iconCarrier">
        {/* Primera capa: Sombra/Cuerpo oscuro */}
        <Path
        ...
        {/* Segunda capa: Azul principal superior */}
        <Path
